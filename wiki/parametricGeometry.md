> [Wiki](Home) » [[Internal Components]] » [[Geometries]] » **parametricGeometry**

# parametricGeometry

Creates a [THREE.ParametricGeometry](https://threejs.org/docs/#api/geometries/ParametricGeometry)
