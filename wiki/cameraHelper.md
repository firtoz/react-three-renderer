> [Wiki](Home) » [[Internal Components]] » [[Objects]] » [[Helpers]] » **cameraHelper**

# cameraHelper

Creates a [THREE.CameraHelper](http://threejs.org/docs/#Reference/Extras.Helpers/CameraHelper)

## Attributes

### cameraName
``` string ``` *``` required ```*: The [name](perspectiveCamera#name) of the camera to visualize.
...
|**[View Source](../blob/master/src/lib/descriptors/Object/Helper/CameraHelperDescriptor.js)**|
 ---|
