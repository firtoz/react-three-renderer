...
var MeshDescriptor = function (_Object3DDescriptor) {
  ...
  function MeshDescriptor() {
    ...
    var _this = _possibleConstructorReturn(this, (MeshDescriptor.__proto__ || Object.getPrototypeOf(MeshDescriptor)).call(this));
    ...
    _this.hasProp('geometry', {
      type: _react2.default.PropTypes.oneOfType([(0, _propTypeInstanceOf2.default)(THREE.Geometry), (0, _propTypeInstanceOf2.default)(THREE.BufferGeometry), (0, _propTypeInstanceOf2.default)(THREE.InstancedBufferGeometry)]),
