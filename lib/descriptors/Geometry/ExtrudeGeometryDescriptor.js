...
var ExtrudeGeometryDescriptor = function (_GeometryWithShapesDe) {
  ...
  function ExtrudeGeometryDescriptor(react3RendererInstance) {
    ...
    _this.hasProp('UVGenerator', {
      type: _ReactPropTypes2.default.shape({
    ...
    _ReactPropTypes2.default.shape({
      tangents: _ReactPropTypes2.default.arrayOf((0, _propTypeInstanceOf2.default)(THREE.Vector3)),
      normals: _ReactPropTypes2.default.arrayOf((0, _propTypeInstanceOf2.default)(THREE.Vector3)),
      binormals: _ReactPropTypes2.default.arrayOf((0, _propTypeInstanceOf2.default)(THREE.Vector3))
    })];
